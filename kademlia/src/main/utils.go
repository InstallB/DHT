...
const (
	...
	basicTestRoundPutSize           int     = 60
	basicTestRoundGetSize           int     = 120
	basicTestRoundDeleteSize        int     = 30
	basicTestMaxFailRate            float64 = 0.01
	basicTestAfterRunSleepTime              = 200 * time.Millisecond
	basicTestJoinQuitSleepTime              = 2000 * time.Millisecond
	basicTestAfterJoinQuitSleepTime         = 15 * time.Second

	forceQuitNodeSize           int     = 60
	forceQuitPutSize            int     = 500
	forceQuitRoundNum           int     = 10
	forceQuitMaxFailRate        float64 = 0.15
	forceQuitRoundQuitNodeSize          = 4
	...
	forceQuitFQSleepTime                = 5000 * time.Millisecond
	...
	QASQuitSleepTime              = 5000 * time.Millisecond
)
